...
from platform_core.utils.geometry import Bounds, parse_bounds_wkt_polygon
    ...
    def upsert_asset(self, metadata: RasterMetadata) -> RasterAsset:
        try:
            ...
            if existing:
                ...
                # Return the existing object - it already has the updated data
                return existing
            ...
            self._session.commit()
            # Return the asset object - it already has all the correct data
            return asset
            ...
            raise RuntimeError(f"Failed to upsert asset: {e}") from e
