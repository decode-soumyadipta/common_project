...
from platform_core.db.models import IngestJob, IngestJobItemStatus, IngestJobStatus
from platform_core.db.session import SessionLocal, init_db
...
class IngestQueueService:
    ...
    def _run_job(self, job_id: str) -> None:
        ...
        while True:
            ...
            try:
                from platform_core.ingestion.services.ingest_service import (
                    register_raster,
                )
