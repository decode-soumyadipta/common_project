...
from client_desktop.backend.measurement_tools.models import (
    ShadowHeightMeasurement,
)
from client_desktop.backend.measurement_tools.dem_utils import sample_dem_height
from client_desktop.backend.measurement_tools.distance import vincenty_distance
