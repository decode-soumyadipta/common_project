...
from client_desktop.backend.measurement_tools.models import ViewshedMeasurement
from client_desktop.backend.measurement_tools.dem_utils import read_dem_window
