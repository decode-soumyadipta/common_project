...
ICON_MANIFEST: dict[str, str] = {
    ...
    "elevation_profile": "mActionMeasureBearing.svg",
    "volume": "mActionSelectRectangle.svg",
...
def _main() -> int:
    ...
    parser.add_argument("--download", action="store_true", help="Download missing icons into desktop/icons")
