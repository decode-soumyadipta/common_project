...
from src_new.clients.desktop_search.measurement_tools.models import ViewshedMeasurement
from src_new.clients.desktop_search.measurement_tools.dem_utils import read_dem_window
